...
This is the base WPILib vendor template for 2026.
...
A native C++ library is built. This has access to all of wpilib, and access to the driver library. This should implement the standard wpilib interfaces. The YAMS native C++ port is located in `../yams/cpp`.
