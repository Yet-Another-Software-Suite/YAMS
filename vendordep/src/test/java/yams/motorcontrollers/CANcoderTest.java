...
public class CANcoderTest {
  ...
  /**
   * Test 3: Verify that an invalid discontinuity point (not 0.5 or 1.0) throws at config-build
   * time. No TalonFX/subsystem is created because the exception fires on
