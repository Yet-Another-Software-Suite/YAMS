...
/**
 * Extend this class when your test requires commands or command groups to be exercised with the
 * full WPI scheduler. Use {@link SchedulerPumpHelper#runForDuration(Runnable, Time, int...)} to
 * pump the scheduler.
 */
