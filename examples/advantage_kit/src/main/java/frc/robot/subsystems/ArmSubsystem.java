...
public class ArmSubsystem extends SubsystemBase
{
  ...
  private final TalonFX intakeMotor = new TalonFX(intakeConstants.MOTOR_ID);
  ...
  private SmartMotorControllerConfig smcConfig = new SmartMotorControllerConfig(this)
      ...
      .withClosedLoopController(intakeConstants.KP,
                                intakeConstants.KI,
                                intakeConstants.KD,
                                DegreesPerSecond.of(intakeConstants.VELOCITY),
                                DegreesPerSecondPerSecond.of(intakeConstants.ACCELERATION))
      .withSimClosedLoopController(intakeConstants.KP,
                                   intakeConstants.KI,
                                   intakeConstants.KD,
                                   DegreesPerSecond.of(intakeConstants.VELOCITY),
                                   DegreesPerSecondPerSecond.of(intakeConstants.ACCELERATION))
      .withFeedforward(new ArmFeedforward(intakeConstants.KS,
                                          intakeConstants.KG,
                                          intakeConstants.KV,
                                          intakeConstants.KA))
      .withSimFeedforward(new ArmFeedforward(intakeConstants.KS,
                                             intakeConstants.KG,
                                             intakeConstants.KV,
                                             intakeConstants.KA))
  ...
  {
    intakePivotInputs.pivotPosition = arm.getAngle();
    intakePivotInputs.pivotVelocity = intakeSMC.getMechanismVelocity();
    intakePivotInputs.pivotAppliedVolts = intakeSMC.getVoltage();
    intakePivotInputs.pivotCurrent = intakeSMC.getStatorCurrent();
  }
  ...
  public void periodic()
  {
    ...
    updateInputs();
    Logger.processInputs("IntakePivotArm", intakePivotInputs);
    arm.updateTelemetry();
  }
  ...
  {
    return intakeSMC.getMechanismPositionSetpoint().orElse(null);
  }
