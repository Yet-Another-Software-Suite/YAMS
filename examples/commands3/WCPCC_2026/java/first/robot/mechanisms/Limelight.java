...
/**
 * MegaTag pose estimates from a Limelight, read through LimelightLib. It is a {@link Mechanism} so
 * an autonomous routine can pause vision by running {@link #idle()} on it.
 */
