...
public class Swerve implements Mechanism {
    ...
    /**
     * Resets odometry to the start of a trajectory, mirrored for the red alliance.
     *
    ...
    /**
     * Follows a Choreo trajectory with {@link #followPath}, mirrored for the red alliance. It samples
     * the trajectory every loop until its total time has passed, then holds the final sample once,
     * matching ChoreoLib's {@code AutoTrajectory.cmd()}.
     *
     * @param trajectory Trajectory to follow, blue alliance origin.
     */
