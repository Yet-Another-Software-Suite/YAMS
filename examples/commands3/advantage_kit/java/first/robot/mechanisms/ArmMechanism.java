...
public class ArmMechanism implements Mechanism {
   ...
   * adjusted without hunting through the mechanism body.
   */
  ...
  /*
   * ArmInputs is the replay boundary for this mechanism. @AutoLog generates
  ...
  public void periodic() {
    // Called by Robot.robotPeriodic() once per loop, before the scheduler runs
    updateInputs();
    ...
    // moment the "replay bubble" closes around this mechanism.
    Logger.processInputs("Arm", armInputs);
    arm.updateTelemetry();
  }

  public void simulationPeriodic() {
    // Called by Robot.simulationPeriodic() once per loop during simulation
    arm.simIterate();
  }
