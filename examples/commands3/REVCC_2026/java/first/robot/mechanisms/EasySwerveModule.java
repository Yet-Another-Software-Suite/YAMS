...
public final class EasySwerveModule
{
   ...
   *
   * @param mechanism             Mechanism that owns the module.
   ...
   */
  public static SwerveModule create(Mechanism mechanism, String name, Translation2d location,
                                    ...
                                    boolean drivingMotorOnBottom, boolean turningMotorOnBottom)
  {
    ...
    SmartMotorControllerConfig drivingConfig = (SmartMotorControllerConfig) new SmartMotorControllerConfig(mechanism)
    ...
    SmartMotorControllerConfig turningConfig = (SmartMotorControllerConfig) new SmartMotorControllerConfig(mechanism)
