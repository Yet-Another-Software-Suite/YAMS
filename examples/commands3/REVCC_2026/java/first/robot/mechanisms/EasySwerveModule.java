...
public final class EasySwerveModule
{
                                    ...
                                    boolean drivingMotorOnBottom, boolean turningMotorOnBottom)
  {
    ...
    SmartMotorControllerConfig drivingConfig = new SmartMotorControllerConfig(mechanism)
    ...
    SmartMotorControllerConfig turningConfig = new SmartMotorControllerConfig(mechanism)
