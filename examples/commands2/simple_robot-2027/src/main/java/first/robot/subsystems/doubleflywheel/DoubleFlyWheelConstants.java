...
package first.robot.subsystems.doubleflywheel;
...
public class DoubleFlyWheelConstants {
   ...
   */
  private record DoubleFlyWheelMeasurement(
      Distance distance, AngularVelocity lowerVelocity, AngularVelocity upperVelocity) {}

  /**
   * Get the {@link InterpolatingDoubleTreeMap}s for the given {@link DoubleFlyWheelMeasurement}s.
   *
   * @param measurements {@link List} of {@link DoubleFlyWheelMeasurement}s to get the {@link
   *     InterpolatingDoubleTreeMap}s for.
   * @return {@link Pair} of({@link InterpolatingDoubleTreeMap} lower, {@link
   *     InterpolatingDoubleTreeMap} upper).
   */
  ...
  public static Pair<InterpolatingDoubleTreeMap, InterpolatingDoubleTreeMap> distanceToRPM =
      getTreeMaps(
          List.of(
              new DoubleFlyWheelMeasurement(
                  Inches.of(12), // 12in from center of goal to center of robot
