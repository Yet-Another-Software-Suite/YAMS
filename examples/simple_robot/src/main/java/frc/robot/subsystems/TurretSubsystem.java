...
public class TurretSubsystem extends SubsystemBase {
  ...
  SmartMotorController motor =
      new TalonFXWrapper(new TalonFX(12), DCMotor.getKrakenX60(1), motorConfig);
  ...
  private final Transform3d roboToTurret =
      new Transform3d(Feet.of(-1.5), Feet.of(0), Feet.of(0.5), Rotation3d.kZero);
  ...
  public ChassisSpeeds getVelocity(ChassisSpeeds robotVelocity, Angle robotAngle) {
    ...
    Translation2d rWorld =
        rRobot.rotateBy(Rotation2d.fromRadians(robotAngle.in(Radians))); // rotate into field frame
