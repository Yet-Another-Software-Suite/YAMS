...
public class ShooterSubsystem extends SubsystemBase {
  ...
  private final SmartMotorControllerConfig motorConfig =
      new SmartMotorControllerConfig(this)
          ...
          .withMomentOfInertia(Inches.of(4), Pounds.of(4))
          //      .withVendorConfig(new TalonFXConfiguration().withVoltage(new
          //      VoltageConfigs().withPeakReverseVoltage(0)))
          //      .withFollowers(Pair.of(flywheelMotor2, flywheelMotor2Inverted))
          .withControlMode(ControlMode.CLOSED_LOOP);
  private final SmartMotorController motor =
      new TalonFXWrapper(flywheelMotor1, DCMotor.getNEO(2), motorConfig);
