...
public class ExponentiallyProfiledElevatorSubsystem extends SubsystemBase {
  ...
  /*
   * To find these limits, measure the starting height relative to the elevator's lowest position
  ...
  /*
   * This is the STARTING Feedforward for the Elevator. If you are using a TalonFX or TalonFXS this
   ...
   * when the Elevator position is unreliable, like startup. Threshold is only detected if exceeded
   * for 0.4 seconds, and the motor moves less than 2 degrees per second.
   *
