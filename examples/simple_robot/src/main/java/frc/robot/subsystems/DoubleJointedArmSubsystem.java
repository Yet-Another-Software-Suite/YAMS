...
public class DoubleJointedArmSubsystem extends SubsystemBase {
  ...
  private final SmartMotorControllerConfig lowerConfig =
  ...
  private final SmartMotorController lowerSMC =
      new SparkWrapper(lowerMotor, DCMotor.getNEO(1), lowerConfig);
  private final ArmConfig lowerArmConfig =
      new ArmConfig()
  ...
  private final SmartMotorControllerConfig upperConfig =
      new SmartMotorControllerConfig(this)
          .withClosedLoopController(16, 0, 0)
          .withTrapezoidalProfile(DegreesPerSecond.of(180), DegreesPerSecondPerSecond.of(90))
          //.withSoftLimits(Degrees.of(-30), Degrees.of(100))
          ...
          .withFeedforward(new ArmFeedforward(0, 0, 0, 0))
          .withControlMode(SmartMotorControllerConfig.ControlMode.CLOSED_LOOP)
          .withMomentOfInertia(Feet.of(2.5), Pounds.of(2))
          .withStartingPosition(Degrees.of(45));
  private final SmartMotorController upperSMC =
      new SparkWrapper(upperMotor, DCMotor.getNEO(1), upperConfig);
  private final ArmConfig upperArmConfig =
      new ArmConfig()
  ...
  private final DoubleJointedArm jointedArm =
      new DoubleJointedArm(lowerArmConfig, lowerSMC, upperArmConfig, upperSMC);
