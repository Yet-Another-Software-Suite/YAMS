...
public class AlignToGoal extends Command
{
   ...
   * @param latency                   Scalar applied to the chassis speeds to compensate for robot velocity.
  ...
  public static Pose2d estimatePose(Pose2d currentPose, ChassisSpeeds fieldOrientedChassisSpeed,
                                    double latency)
  {
    var deltaSpeed       = fieldOrientedChassisSpeed.times(latency);
    ...
    return new Pose2d(currentPose.getTranslation().plus(deltaTranslation),
                      currentPose.getRotation()
                                 .plus(new Rotation2d(Radians.of(fieldOrientedChassisSpeed.omegaRadiansPerSecond)
                                                             .times(latency))));
  }
  ...
  public AlignToGoal(SwerveSubsystem swerveSubsystem, SwerveInputStream inputStream, Pose2d targetPose)
  {
