...
SwerveDriveTelemetryConfig::SwerveDriveTelemetryConfig() {
  m_poseFields.emplace(
      ...
      StructTelemetry<wpi::math::Pose2d, StructTelemetryField>{
          "tuning/driveToPose", wpi::math::Pose2d{}, StructTelemetryField::TargetPose, true});
  m_poseFields.emplace(
...
std::unordered_map<
    SwerveDriveTelemetryConfig::StructTelemetryField,
    StructTelemetry<wpi::math::ChassisVelocities, SwerveDriveTelemetryConfig::StructTelemetryField>>&
