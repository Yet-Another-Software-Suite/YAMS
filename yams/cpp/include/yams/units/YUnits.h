...
using FathomUnit  = ::units::unit<std::ratio<18288, 10000>, ::units::meters>; ///< 1 fathom = 1.8288 m.
using FurlongUnit = ::units::unit<std::ratio<201168, 1000>, ::units::meters>; ///< 1 furlong = 201.168 m.
using MileUnit    = ::units::unit<std::ratio<1609344, 1000>, ::units::meters>; ///< 1 mile = 1609.344 m.
using LeagueUnit  = ::units::unit<std::ratio<4828032, 1000>, ::units::meters>; ///< 1 league = 4828.032 m.
...
using FortnightUnit = ::units::unit<std::ratio<1209600>, ::units::seconds>; ///< 1 fortnight = 1209600 s.
using YearUnit      = ::units::unit<std::ratio<31536000>,::units::seconds>; ///< 1 year = 31536000 s (365 days).
