...
using HandUnit =
    ::wpi::units::unit<std::ratio<10160, 10000>, ::wpi::units::meters>;  ///< 1 hand = 0.1016 m.
using YardUnit =
    ::wpi::units::unit<std::ratio<9144, 10000>, ::wpi::units::meters>;  ///< 1 yard = 0.9144 m.
using CubitUnit =
    ::wpi::units::unit<std::ratio<4572, 10000>, ::wpi::units::meters>;  ///< 1 cubit = 0.4572 m.
using FathomUnit =
...
using LeagueUnit = ::wpi::units::unit<std::ratio<4828032, 1000>,
                                      ::wpi::units::meters>;  ///< 1 league = 4828.032 m.
...
using WeekUnit =
    ::wpi::units::unit<std::ratio<604800>, ::wpi::units::seconds>;  ///< 1 week = 604800 s.
using FortnightUnit =
    ::wpi::units::unit<std::ratio<1209600>, ::wpi::units::seconds>;  ///< 1 fortnight = 1209600 s.
using YearUnit = ::wpi::units::unit<std::ratio<31536000>,
                                    ::wpi::units::seconds>;  ///< 1 year = 31536000 s (365 days).
