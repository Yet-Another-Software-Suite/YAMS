...
/**
 * Sensor class using {@link org.wpilib.hardware.hal.SimDevice}; All fields will use the given
 * supplier on real robots. Fake data is only given when connected to simulation.
 *
 * <p>
 ...
 * construction time. In <b>simulation</b>, a {@link org.wpilib.hardware.hal.SimDevice} is
 * registered with WPILib so the WPILib Glass simulation GUI can read and override individual field
 * values, enabling hardware-in-the-loop-style testing without real hardware.
 * </p>
 *
 * <p>
