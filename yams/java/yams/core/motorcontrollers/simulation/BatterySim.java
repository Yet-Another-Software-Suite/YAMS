...
public class BatterySim {
   ...
   * its {@link yams.core.motorcontrollers.SmartMotorController} has been closed. Without this, a
   * closed simulation's last-known current draw would linger in {@link #currents} indefinitely.
   *
  ...
  public static double getStateOfCharge() {
    return Math.clamp(1.0 - (ampHoursUsed / batteryCapacityAmpHours), 0.0, 1.0);
  }
