...
public class SwerveDriveTelemetry {
    ...
    for (Map.Entry<StructTelemetryField, StructTelemetry<?, StructTelemetryField>> entry :
      ...
      switch (stt.getField()) {
        ...
        case DesiredRobotRelativeChassisSpeeds ->
          ((StructTelemetry<ChassisVelocities, StructTelemetryField>) stt)
    ...
    for (Map.Entry<StructArrayTelemetryField, StructArrayTelemetry<?, StructArrayTelemetryField>>
      ...
      switch (stat.getField()) {
        case DesiredModuleStates ->
          ((StructArrayTelemetry<SwerveModuleVelocity, StructArrayTelemetryField>) stat)
  ...
  public void applyTuningValues(SwerveDrive drive) {
    ...
    if (azimuthTuningOn) {
      var angle = Rotation2d.fromDegrees(
  ...
  public enum StructTelemetryField {
    ...
    DesiredRobotRelativeChassisSpeeds(
        "chassis/desired", ChassisVelocities.struct, new ChassisVelocities(), false),
    /** Measured robot relative {@link ChassisVelocities}. */
    CurrentRobotRelativeChassisSpeeds(
        "chassis/current", ChassisVelocities.struct, new ChassisVelocities(), false),
    /** Measured field relative {@link ChassisVelocities}. */
    FieldRelativeChassisSpeeds(
        "chassis/field", ChassisVelocities.struct, new ChassisVelocities(), false);
  ...
  public enum StructArrayTelemetryField {
    ...
    DesiredModuleStates(
        "states/desired", SwerveModuleVelocity.struct, new SwerveModuleVelocity[0], false),
    /** Measured {@link SwerveModuleVelocity}s. */
    CurrentModuleStates(
        "states/current", SwerveModuleVelocity.struct, new SwerveModuleVelocity[0], false);
