 ...
 * {@link SwerveModuleVelocity} to NetworkTables and/or a WPILib DataLog, and wires the
 * drive/azimuth
 * {@link yams.core.motorcontrollers.SmartMotorController}s' own telemetry under the same module
 * subtable.
 *
 ...
 * {@link yams.core.mechanisms.config.SwerveModuleConfig#withTelemetry(String, yams.core.telemetry.enums.TelemetryVerbosity)}
...
public class SwerveModuleTelemetry {
   ...
   *
   * @param mechName Telemetry name of the parent {@link yams.core.mechanisms.swerve.SwerveDrive}.
