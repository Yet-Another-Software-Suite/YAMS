 ...
 * SmartMotorController driveMotor = new TalonFXWrapper(new TalonFX(1), DCMotor.getKrakenX60(1),
 * driveConfig); SmartMotorController steerMotor = new TalonFXWrapper(new TalonFX(2),
 * DCMotor.getFalcon500(1), steerConfig);
 *
