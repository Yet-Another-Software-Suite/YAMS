 ...
 *
 * <p>The following example builds a four-module swerve drive using NEO motors controlled by {@code
 * SparkMax} controllers and CANcoder absolute encoders. Modules are ordered <b>clockwise from
 ...
 *
 *     SmartMotorController driveSMC   = new SparkWrapper(driveMotor,   DCMotor.getNEO(1),
 * driveCfg); SmartMotorController azimuthSMC = new SparkWrapper(azimuthMotor, DCMotor.getNEO(1),
 * azimuthCfg);
 *
