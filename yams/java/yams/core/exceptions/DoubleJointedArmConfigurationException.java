...
/**
 * Thrown by {@link yams.core.mechanisms.positional.DoubleJointedArm} when a required field in the
 * lower-joint or upper-joint {@link yams.core.mechanisms.config.ArmConfig} is missing or invalid.
 *
 ...
 * lowerMotorCfg)); ArmConfig upperConfig = new ArmConfig()
 *     .withSmartMotorController(SmartMotorController.create(SPARK_MAX, DCMotor.getNEO(1),
 * upperMotorCfg)); DoubleJointedArm arm = new DoubleJointedArm(lowerConfig, upperConfig);
 * }</pre>
 *
 * @see yams.core.mechanisms.positional.DoubleJointedArm
