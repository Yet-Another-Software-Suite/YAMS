 ...
 *
 * // Query the ratios
 * double rotorToMech = combined.getRotorToMechanismRatio(); // motor rotations per mechanism
 * rotation double mechToRotor = combined.getMechanismToRotorRatio(); // mechanism rotations per
 * motor rotation
 * }</pre>
 */
