...
/**
 * Thrown by {@link yams.mechanisms.swerve.SwerveDrive} or {@link yams.mechanisms.config.SwerveDriveConfig} when a required field is missing or a config invariant
 * is violated.
 *
 ...
 * configs, a gyro source, and the required kinematic geometry before constructing {@link yams.mechanisms.swerve.SwerveDrive}. Consult the {@code SwerveDriveConfig} builder methods for
 * the specific setter that the error message recommends.
 *
