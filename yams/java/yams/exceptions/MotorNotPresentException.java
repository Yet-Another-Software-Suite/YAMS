...
/**
 * Thrown by a {@link yams.mechanisms.SmartMechanism} subclass when the primary {@link yams.motorcontrollers.SmartMotorController} has not been set before the mechanism attempts to use
 * it.
 *
