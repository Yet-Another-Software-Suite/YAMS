...
/**
 * Thrown by {@link yams.gearing.GearBox} and {@link yams.gearing.Sprocket} when a gear stage string
 * is not in the required {@code "IN:OUT"} format.
 *
 * <p>Each stage passed to a {@code GearBox} or {@code Sprocket} constructor must be a {@code String} containing exactly one colon ({@code :}) separating the driver tooth count from the
 ...
 *
 * <p><b>Resolution:</b> Correct the malformed stage string so it follows the {@code "driverTeeth:drivenTeeth"} pattern.
 *
