...
/**
 * Thrown by {@link yams.mechanisms.positional.Elevator} when a required {@link yams.mechanisms.config.ElevatorConfig} field is missing or invalid.
 *
 ...
 * distances, {@code ElevatorConfig.withMass(Mass)} provides the carriage mass, and {@code ElevatorConfig.withStartingHeight(Distance)} sets the initial position.
 *
