 ...
 * terms of physical hardware (tooth counts, sprocket sizes, output dimensions) instead of manually
 * computing reduction fractions. All classes are immutable value types designed to be constructed
 * once at robot initialization and reused throughout the match.
 *
 * <h2>Core Classes</h2>
 *
 * <ul>
 ...
 *
 * <p>Pass the driver tooth count first, then the driven tooth count. The ratio is {@code driven / driver}, so {@code 12} driver teeth and {@code 60} driven teeth produces a 5:1 reduction:
 *
 * <pre>{@code
