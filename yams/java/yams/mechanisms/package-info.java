 ...
 *
 * <ol>
 * <li><b>Create a configuration object</b> — choose the appropriate config class from {@link yams.mechanisms.config} (e.g. {@link yams.mechanisms.config.ArmConfig}, {@link yams.mechanisms.config.ElevatorConfig}) and populate it via the fluent
 * {@code with*()} API.
