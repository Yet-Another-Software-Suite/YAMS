 ...
 * closed-loop position logic, soft-limit enforcement, simulation wiring, and WPILib command/trigger
 * integration.
 *
 ...
 *
 * <p>Each positional mechanism exposes factory methods that return {@link edu.wpi.first.wpilibj2.command.button.Trigger} objects. These allow condition-based command
