 ...
 *     new
 * SmartMotorControllerConfig().withClosedLoopController(0.2,0,0).withStatorCurrentLimit(Amps.of(40)));
  ...
  public Arm(ArmConfig config, SmartMotorController smc) {
    ...
    if (RobotBase.isSimulation()) {
      ...
      m_mechanismRoot.append(new MechanismLigament2d("MaxHard", Inch.of(3).in(Meters),
          config.getUpperHardLimit().get().in(Degrees), 4, new Color8Bit(Color.kLimeGreen)));
      m_mechanismRoot.append(new MechanismLigament2d("MinHard", Inch.of(3).in(Meters),
          config.getLowerHardLimit().get().in(Degrees), 4, new Color8Bit(Color.kRed)));
      if (smccfg.getMechanismLowerLimit().isPresent()
        ...
        m_mechanismRoot.append(new MechanismLigament2d("MaxSoft", Inch.of(3).in(Meters),
            smccfg.getMechanismUpperLimit().get().in(Degrees), 4, new Color8Bit(Color.kHotPink)));
        m_mechanismRoot.append(new MechanismLigament2d("MinSoft", Inch.of(3).in(Meters),
            smccfg.getMechanismLowerLimit().get().in(Degrees), 4, new Color8Bit(Color.kYellow)));
      }
