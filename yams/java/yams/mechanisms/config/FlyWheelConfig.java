...
public class FlyWheelConfig {
   ...
   *
   * <p>The speedometer simulation is a simulation of a speedometer that is used to simulate the
   ...
   *
   * <p>The speedometer simulation is a simulation of the speedometer that is used to simulate the
   * behavior of the shooter. This is useful for testing and debugging the shooter without having to
   * physically move it.
   *
