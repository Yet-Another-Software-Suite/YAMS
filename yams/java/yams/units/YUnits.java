 ...
 * for FRC robotics or simply entertaining. Beyond what WPILib provides out of the box, {@code YUnits} adds:
 *
 * <ul>
 * <li><b>Imperial distance units</b> — {@link #Hands}, {@link #Yards}, {@link #Cubits}, {@link #Fathoms}, {@link #Chains}, {@link #Furlongs}, {@link #Miles}, {@link #Leagues}, and even a
 *       {@link #FootlongSandwich}.
 * <li><b>Extended time units</b> — {@link #Hours}, {@link #Days}, {@link #Weeks}, {@link #Fortnight}, and {@link #Years}.
 *   <li><b>Derived velocity units</b> — {@link #MilesPerHour} (MPH), {@link #FurlongsPerFortnight}
 *       (FPF), and {@link #SandwichPerSecond} for all your footlong-based kinematics.
 * <li><b>Angular velocity and acceleration</b> — {@link #RotationsPerYear} (RPY) and {@link #RPMPerSecond} for angular acceleration in RPM/s.
 * <li><b>Linear and angular momentum units</b> — {@link #PoundFeetPerSecond}, {@link #PoundInchesPerSecond}, {@link #PoundFeetSquaredPerSecond}, and {@link #PoundInchesSquaredPerSecond}.
 *   <li><b>Moment of inertia units</b> — {@link #PoundSquareFeet} and {@link #PoundSquareInches}
 *       for imperial rotational inertia calculations.
 * </ul>
 *
 * <h2>Example</h2>
 *
...
public class YUnits {
  ...
  /**
   * 1 {@link edu.wpi.first.units.Units#Feet}, or <a
  ...
  /**
   * 20.1168 (Except in India, where it is 20 meters) {@link edu.wpi.first.units.Units#Meters}s, or
   * 66 {@link edu.wpi.first.units.Units#Feet}.
   */
