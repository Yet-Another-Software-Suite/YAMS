 ...
 * mechanism config classes found in the {@code yams.mechanisms.config} sub-package, such as {@link yams.mechanisms.config.ArmConfig}. Construct a config, supply the required hardware parameters,
 * then pass it to the corresponding mechanism class to obtain a fully configured, telemetry-enabled
 * mechanism instance.
 *
